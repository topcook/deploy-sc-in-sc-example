...
contract('Contracts', function (accounts) {
  ...
  before(async () => {
    MomContract = await hre.ethers.getContractFactory('MomContract')
    DaughterContract = await hre.ethers.getContractFactory('DaughterContract')
    SonContract = await hre.ethers.getContractFactory('SonContract')
  });
